...
bump_version() {
  ...
  if [[ -f "$target_dir/package.json" ]]; then
    ...
    current_version="$(cat "$target_dir/VERSION" 2>/dev/null | tr -d '[:space:]' || true)"
  fi
